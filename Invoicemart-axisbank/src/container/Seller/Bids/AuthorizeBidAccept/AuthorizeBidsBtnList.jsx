...
import AuthorizeBid from "../../../../assets/SvgIcons/FU/AuthorizeBid.svg";
import AuthorizeBidlight from "../../../../assets/SvgIcons/FU/AuthorizeBidlight.svg";
  ...
  return (
    <div>
      <Button
        ...
        startIcon={
          <img
            src={_dark ? AuthorizeBidlight : AuthorizeBid}
            className={classes.imgCls}
            alt="Bid"
          />
        }
        onClick={() => {
          props.handleAuthorizeBid();
        }}
      >
        Authorize Bids
      </Button>
      {/* <Button className={classes.btnCls} startIcon={<img src={_dark ? CancelBidlight : CancelBid} className={classes.imgCls} alt="Bid"/>}>Cancel Bids</Button>  */}
      {/* <Button className={classes.btnCls} startIcon={<img src={_dark ? InsureFUlight : InsureFU} className={classes.imgCls} alt="Bid"/>}>Insure FUS</Button> */}
      <Button
        className={classes.btnCls}
        startIcon={
          <img
