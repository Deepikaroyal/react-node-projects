      ...
      <Card style={{ marginTop: "15px", boxShadow: "0 3px 5px #bebebe" }}>
        <CardContent>
          <Typography className={classes.TypFUoutstandHdrCls}>
            FU Outstanding Report
          </Typography>
          <Typography className={classes.TypFuoutstandCls}>
            Report shall be generated as on date
          </Typography>
          <Stack
