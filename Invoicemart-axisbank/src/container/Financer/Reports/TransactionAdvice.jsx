...
const TransactionAdvice = (props) => {
  ...
  const [branchbnk, setbranchbnk] = React.useState(null);

  const handlebranchbnkChange = (event) => {
    // console.log(event);
    setbranchbnk(event.target.value);
  };
          ...
          >
            ...
            <div>
              <Select
                value={branchbnk}
                label="Branch Bank"
                onChange={handlebranchbnkChange}
                size="small"
                width="335px"
                data={BranchBnk}
              />
...
export default TransactionAdvice;
