...
import Create from "../../../../assets/SvgIcons/Admin/create.svg";
import CreateLight from "../../../../assets/SvgIcons/Admin/create-1.svg";
import Activate from "../../../../assets/SvgIcons/Admin/activate.svg";
import ActivateLight from "../../../../assets/SvgIcons/Admin/activate-1.svg";
import Deactivate from "../../../../assets/SvgIcons/Admin/deactivate.svg";
import DeactivateLight from "../../../../assets/SvgIcons/Admin/deactivate-1.svg";
  ...
  return (
    <div>
      <Button
        ...
        startIcon={
          <img src={_dark ? CreateLight : Create} height="17" alt="workflow" />
        }
        onClick={() => {
          props.handleOpen();
        }}
      ...
      <Button
        className={classes.btnCls}
        startIcon={
          <img src={_dark ? ActivateLight : Activate} height="17" alt="Bid" />
        }
      >
        Activate
      </Button>
      <Button
        ...
        startIcon={
          <img
            src={_dark ? DeactivateLight : Deactivate}
            height="17"
            alt="Bid"
          />
        }
