...
import Authorizechanges from "../../../../assets/SvgIcons/Admin/Authorizechanges.svg";
import AuthorizechangesLight from "../../../../assets/SvgIcons/Admin/Authorizechanges-1.svg";
...
export default function AuthorizeLimitButtons(props) {
  ...
  return (
    <div>
      ...
      <Button
        ...
        startIcon={
          <img
            src={_dark ? AuthorizechangesLight : Authorizechanges}
            height="17"
            alt="Bid"
          />
        }
