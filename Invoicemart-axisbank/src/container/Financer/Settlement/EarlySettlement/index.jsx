...
import Fudetails from "../FUNumdetail";
import InvoiceDetails from "../FUNumdetail/InvoiceDetails";
import DataGrid from "../../../../components/DataGrid";
import BackButton from "../../../../components/Common/BackButton";
import EarlySettlementButton from "./EarlySettlementBtn";
...
const FUList = (props) => {
  ...
  return (
    <>
      ...
      {props.page === "list" ? (
        <>
          <EarlySettlementButton _dark={_dark} />
