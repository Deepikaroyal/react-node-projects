...
import Step1 from "../Forgotpassword/Recovery";
import Step2 from "../Forgotpassword/OTP";
            ...
            <Grid align="center">
              ...
              {recoveryChk ? (
                <>
                  ...
                  {passwordError ? (
                    <label className="pin-error">{passwordError}</label>
                  ) : (
                    ""
                  )}
                </>
              ...
              {recoveryChk ? (
                <>
                  ...
                  <Grid container>
                    <Grid item xs={8}>
                      <OtpText PinValue={confirmPin} />
                    </Grid>
                  </Grid>
                  {confirmpasswordError ? (
                    <label className="pin-error">{confirmpasswordError}</label>
                  ) : (
                    ""
                  )}
                </>
