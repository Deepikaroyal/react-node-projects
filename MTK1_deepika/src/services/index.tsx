...
export const  getCategoryService = async(pageCount:number) =>{
    return   await axios.get(api.Food_list_url+`list?pageSize=10&pageNumber=${pageCount}&api_key=`+setting.api.Auth,{
      headers : {
