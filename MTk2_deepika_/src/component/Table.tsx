...
const McDonaldsNutriotionDetails = () => {
    ...
    const get_catogary_realated_items = async (itemList: any) => {
        ...
        for (let obj in itemList) {
            let product_obj = itemList[parseInt(obj)]['data']
            let category = product_obj['category']
            let product_name = product_obj['product_name']
            let product_nutrition = product_obj['nutrition_details']
...
export default McDonaldsNutriotionDetails
